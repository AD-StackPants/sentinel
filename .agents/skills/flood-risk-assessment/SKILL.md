...
Query these tables from SENTINEL_AI_DB.PUBLIC:
- RIVER_SENSORS — live water level readings and alert levels
- WEATHER_DATA — rainfall, wind speed, storm info
- FLOOD_HISTORY — historical flooding events per barangay
- BARANGAYS — population and location data
